...
-- Tempo de geração: 23/04/2024 às 18:12
...
CREATE TABLE IF NOT EXISTS `consultas_medico_links` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `consulta_id` int UNSIGNED DEFAULT NULL,
  `medico_id` int UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `consultas_medico_links_unique` (`consulta_id`,`medico_id`),
  KEY `consultas_medico_links_fk` (`consulta_id`),
  KEY `consultas_medico_links_inv_fk` (`medico_id`)
...
CREATE TABLE IF NOT EXISTS `medicos` (
  ...
  `updated_by_id` int UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `medicos_created_by_id_fk` (`created_by_id`),
  KEY `medicos_updated_by_id_fk` (`updated_by_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
